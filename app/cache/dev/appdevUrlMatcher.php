...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'cordova_formmodel_default_index');
            }
            return array (  '_controller' => 'Cordova\\Bundle\\FormModelBundle\\Controller\\DefaultController::indexAction',  '_route' => 'cordova_formmodel_default_index',);
        }
